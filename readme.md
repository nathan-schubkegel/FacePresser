...
About
-----
This is a C# console app that uses Facebook's Graph API to fetch the most recent post on a public facebook page and re-post it on a WordPress site. You leave the app running and every few minutes it polls to check for a new or updated facebook post.
...
Building/Running
----------------
Download and install .NET 7 from https://dotnet.microsoft.com/en-us/download/dotnet/7.0 (the project could easily be updated to .NET 8 or later but it's a pain to update the linux machine I'm running this on, so .NET 7 for now)
...
This project uses Windows-platform-specific and Linux platform-specific \*.pfx cert creation code.
...
- Newtonsoft.Json - MIT License - see https://github.com/JamesNK/Newtonsoft.Json/tree/13.0.4
- BouncyCastle.Cryptography - MIT License - see https://github.com/bcgit/bc-csharp/tree/release-2.6.2
